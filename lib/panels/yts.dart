...
class Yts extends StatefulWidget {
  const Yts({Key? key}) : super(key: key);
...
class _YtsState extends State<Yts> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: YtsWebViewStack(controller: controller),
    );
  }
}

class YtsWebViewStack extends StatefulWidget {
  const YtsWebViewStack({Key? key, required this.controller}) : super(key: key);
  final Completer<WebViewController> controller; // Add this attribute

  @override
  State<YtsWebViewStack> createState() => _YtsWebViewStackState();
}

class _YtsWebViewStackState extends State<YtsWebViewStack> {
