...
class _SearchState extends State<Search> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SearchWebViewStack(controller: controller),
    );
  }
}

class SearchWebViewStack extends StatefulWidget {
  const SearchWebViewStack({Key? key, required this.controller})
      : super(key: key);
  final Completer<WebViewController> controller; // Add this attribute

  @override
  State<SearchWebViewStack> createState() => _SearchWebViewStackState();
}

class _SearchWebViewStackState extends State<SearchWebViewStack> {
